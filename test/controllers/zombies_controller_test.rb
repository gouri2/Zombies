...
class ZombiesControllerTest < ActionController::TestCase
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post :create, zombie: { age: @zombie.age, birthday: @zombie.birthday, name: @zombie.name, salary: @zombie.salary, works: @zombie.works }
    end
  ...
  test "should update zombie" do
    patch :update, id: @zombie, zombie: { age: @zombie.age, birthday: @zombie.birthday, name: @zombie.name, salary: @zombie.salary, works: @zombie.works }
    assert_redirected_to zombie_path(assigns(:zombie))
  end
